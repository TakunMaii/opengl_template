...
HEADER=src/utils/file.h src/utils/log.h src/shader/shader.h src/math/linear_algebra.h src/render/mesh.h src/render/model.h src/render/color.h src/core/core.h src/core/core_internal.h src/core/input.h
ROOT_SOURCE=src/main.c src/glad.c
SOURCE=src/utils/file.c src/utils/log.c src/shader/shader.c src/math/linear_algebra.c src/render/mesh.c src/render/model.c src/render/color.c src/core/core.c src/core/input.c
